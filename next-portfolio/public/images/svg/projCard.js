export default function Split({ fillColor, index }) {
    return (
        <svg className="proj-svg" fill={fillColor} id={"proj-svg-"+index} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" version="1.1">
                    <defs> 
                        <linearGradient id={"proj-gradient-"+index} x1="0" x2="1" y1="1" y2="0">
                            <stop id="stop1" stopColor={fillColor} offset="0%"></stop>
                            <stop id="stop2" stopColor={fillColor} offset="100%"></stop>
                        </linearGradient>
                    </defs>
