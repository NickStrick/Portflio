...
export default function Logo({ fillColor='#28da00' }) {
    return (
        ...
        <path fill="url(#paint1_linear_9174_234436)" d="M512.334 299.85C291.226 540.225 221.663 160.056-154.553 416.352c-76.26 51.952-113.95 89.709-125.572 129.647H1229.98l274.68-341.638s-303.11-347.643-454.33-93.784C899.098 364.435 733.442 59.475 512.334 299.85Z"/>
        <path fill="#fff" d="M1525.94 282.91c-66.45 124.52 235.05 390.53 23.17 264.103-211.89-126.428-513.94 427.508-839.104 148.32C384.84 416.145 207.883 908.052-37.766 724.501c-245.649-183.552-94.339 253.138-217.896 68.03-123.556-185.108 71.554-157.642 239.772-353.32s244.936 117.563 500.225-95.784c255.289-213.346 462.491 27.719 671.505-244.223 209.02-271.941 614.12-273.54 370.1 183.706Z"/>
        </g>
        <defs>
        ...
        <feColorMatrix values="0 0 0 0 0.379167 0 0 0 0 0.254547 0 0 0 0 0.0126389 0 0 0 0.1 0"/>
        <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_9174_234436"/>
        <feBlend in="SourceGraphic" in2="effect1_dropShadow_9174_234436" result="shape"/>
        </filter>
        </defs>
        </svg>
    );
