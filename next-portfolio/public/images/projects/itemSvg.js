...
export default function Split({ fillColor, index }) {
    return (
        ...
        <path d="M 0,600 L 0,225 C 132.8,194.60000000000002 265.6,164.20000000000002 418,191 C 570.4,217.79999999999998 742.4000000000001,301.8 916,342 C 1089.6,382.2 1264.8,378.6 1440,375 L 1440,600 L 0,600 Z" stroke="none" strokeWidth="0" fill={"url(#projwave-gradient"+index+")"} fillOpacity="1" className="transition-all duration-300 ease-in-out delay-150 path-0">
            </path>
        </svg>
    );
  }