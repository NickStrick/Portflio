export default function Split({ fillColor, index }) {
    return (
        <svg id={"proj-svg-"+index} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" version="1.1">
                    <defs> 
